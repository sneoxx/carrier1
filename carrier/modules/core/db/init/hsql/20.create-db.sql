...
alter table CARRIER_DELIVERY add constraint FK_CARRIER_DELIVERY_ON_EXT_USER foreign key (EXT_USER_ID) references SEC_USER(ID)^
create index IDX_CARRIER_DELIVERY_ON_CARRIER on CARRIER_DELIVERY (CARRIER_ID)^
create index IDX_CARRIER_DELIVERY_ON_EXT_USER on CARRIER_DELIVERY (EXT_USER_ID)^
